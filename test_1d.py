...
acq_opt_maKG = GPyOpt.optimization.AcquisitionOptimizer(optimizer='lbfgs', space=space)
acq_opt_maEI = GPyOpt.optimization.AcquisitionOptimizer(optimizer='lbfgs', space=space)
